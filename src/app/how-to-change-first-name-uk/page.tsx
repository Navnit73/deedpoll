...
export const metadata = {
  ...
  title: "How to Change Your First Name UK | Deed Poll UK",
  description: "Learn how to change your first name uk. Guide covers: how to change first name uk, how to legally change your first name uk, and more.",
};

export default function Page() {
  const keywords = [
    "how to change first name uk",
    "how to legally change your first name uk",
    "how to change your first name legally uk",
    "how to change middle name uk",
    "how to change your middle name uk"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change your first name uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
