  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-12 text-lg font-bold text-[#1d70b8]">
        ...
        <li><a href="#deedpolluk-org-uk" className="hover:underline underline-offset-2">DeedPollUK.co.uk</a></li>
      ...
      <div className="space-y-4 mb-12">
        ...
        <FaqItem id="other-countries" summary="How can I change my name in other countries?">
          ...
          <p className="mt-4">
            ...
            <em>can</em> use a deed poll generated by DeedPollUK.co.uk. In this instance, you can change your
      ...
      {/* SECTION 3 */}
      <h2 id="deedpolluk-org-uk" className="text-3xl font-bold mb-6 pt-4 scroll-mt-20 border-t border-[#b1b4b6]">DeedPollUK.co.uk</h2>
      ...
      <div className="space-y-4 mb-12">
        ...
        <FaqItem id="suggestions" summary="Can I make a suggestion for this site? Can I report a bug?">
          ...
          <p className="mt-4">
            Alternatively, send an email to <a href="mailto:dan@DeedPollUK.co.uk" className="text-[#1d70b8] underline underline-offset-2">dan@DeedPollUK.co.uk</a> and I'll
            see if I can help.
          </p>
        </FaqItem>
