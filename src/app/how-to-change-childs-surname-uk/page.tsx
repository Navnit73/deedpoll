...
export const metadata = {
  ...
  title: "How to Change a Childs Surname UK | Deed Poll UK",
  description: "Learn how to change a childs surname uk. Guide covers: how can i change my childs surname uk, how to change a childs name uk, and more.",
};

export default function Page() {
  const keywords = [
    "how can i change my childs surname uk",
    "how to change a childs name uk",
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-8 capitalize">
        How to Change a Childs Surname UK
      </h1>
      
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change a childs surname uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
