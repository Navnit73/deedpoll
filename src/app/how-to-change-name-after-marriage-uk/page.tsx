...
export const metadata = {
  ...
  title: "How to Change Name After Marriage UK | Deed Poll UK",
  description: "Learn how to change name after marriage uk. Guide covers: how to change my name after marriage uk, how to change surname after marriage uk, and more.",
};

export default function Page() {
  const keywords = [
    "how to change my name after marriage uk",
    "how to change surname after marriage uk",
    "how to change last name after marriage uk",
    "how to change your name after marriage uk",
    "how to change to married name uk",
    "how to change name after wedding uk",
    "how to change name once married uk",
    "how to change name when married uk"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change name after marriage uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
