...
export const metadata = {
  ...
  title: "How to Change Name on Birth Certificate UK | Deed Poll UK",
  description: "Learn how to change name on birth certificate uk. Guide covers: how to change your name on birth certificate uk, how to change surname on birth certificate in uk, and more.",
};

export default function Page() {
  const keywords = [
    "how to change your name on birth certificate uk",
    "how to change surname on birth certificate in uk"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change name on birth certificate uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
