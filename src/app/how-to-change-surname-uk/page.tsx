...
export const metadata = {
  ...
  title: "How to Change Surname UK | Deed Poll UK",
  description: "Learn how to change surname uk. Guide covers: how to change my surname uk, how to change your surname in the uk, and more.",
};

export default function Page() {
  const keywords = [
    "how to change my surname uk",
    "how to change your surname in the uk",
    "how to change your second name uk",
    "how to change your surname legally uk",
    "how do i change my surname uk"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change surname uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
