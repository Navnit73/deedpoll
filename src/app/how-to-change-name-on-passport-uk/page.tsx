...
export const metadata = {
  ...
  title: "How to Change Name on Passport UK | Deed Poll UK",
  description: "Learn how to change name on passport uk. Guide covers: how do i change my name on my passport uk, how to change your name on passport uk, and more.",
};

export default function Page() {
  const keywords = [
    "how do i change my name on my passport uk",
    "how to change your name on passport uk",
    "how to change name in uk passport"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how to change name on passport uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
