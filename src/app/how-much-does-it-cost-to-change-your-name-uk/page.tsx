...
export default function Page() {
  const keywords = [
    ...
    "how much to change name uk",
    "how much to legally change your name uk",
    "how much is it to legally change your name uk",
    "how much does it cost to change your surname uk"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      ...
      <div className="bg-[#f3f2f1] border-l-[8px] border-[#1d70b8] p-6 mb-8">
        <p className="text-xl">
          Welcome to our comprehensive guide on <strong>how much does it cost to change your name uk</strong>. If you are looking for answers about changing your name legally and officially, you are in the right place.
        </p>
      </div>
